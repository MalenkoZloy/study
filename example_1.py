...
# Этот код представляет собой пример использования функций обратного вызова в Python.
...
# 9. process_number(entered_num, print_number_info) вызывает функцию process_number, передавая ей в пользователем число и функцию print_number_info в качестве функции обратного вызова.
# В итоге, программа проверяет, является ли в пользователем число четным или нечетным, используя функцию print_number_info, которая вызывается через функцию обратного вызова process_number.